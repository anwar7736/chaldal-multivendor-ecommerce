...
<div class="loaded">
    <div>
        <form action="{{ route('front.checkout.store') }}" method="POST" id="ajaxForm">
            @csrf
                        ...
                        <div class="deliveryStepContent">
                            <div class="addressComponent mui">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control shadow-none" name="billing_name" id="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Billing Email</label>
                                    <input type="text"
                                        class="form-control shadow-none" name="billing_email" id="" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Billing Phone</label>
                                    <input type="text"
                                        class="form-control shadow-none" name="billing_phone" id="" placeholder="">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="orderSection left">
                                <div class="orderSuccessContainer">
                                    <div class="orderSuccess">
                                        ...
                                        <input type="hidden" name="shipping_method" value="Home Delivery">
                        ...
                        <button class="confirmBtn confirmOrder" type="submit">
                            <div>
                                ...
                                <div class="placeOrderPrice">
                                    <span>৳ </span>
                                    <span>{{ cartTotalAmount()['total'] ?? 0 }}</span>
                                </div>
                            </div>
                        </button>
